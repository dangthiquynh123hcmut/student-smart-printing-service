...
function HighlightedMachine  ({ machineName }) {
  return (
    ...
    >
      <Typography variant="body1" sx={{ margin: 0, color: "inherit", fontWeight: "inherit" }}>
        {machineName}
      </Typography>
            ...
            <TableBody>
              {Array.isArray(data) ? (data.map((row) => (
                <TableRow key={row.id}>   
                  ...
                  <TableCell><StatusBadge status={row?.process} /></TableCell>
                  <TableCell>{row?.user.mssv}</TableCell>
                  <TableCell><HighlightedMachine machineName={row?.printMachine.name} /></TableCell> 
                  {/* <TableCell></TableCell> */}
                </TableRow>
              ))):(
                <TableRow key={data.id}> 
                  ...
                  <TableCell><StatusBadge status={data?.process} /></TableCell>
                  <TableCell>{data.user.mssv}</TableCell>
                  <TableCell><HighlightedMachine machineName={data.printMachine.name} /></TableCell>
